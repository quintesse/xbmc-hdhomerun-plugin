...
# hdhomerun.py
#
# Copyright (c) 2012 Tako Schotanus <tako@codejive.org>.
#
...
class LibHdhr:
    def __init__(self):
        if (sys.platform == 'linux2'):
            ...
            lib = self._libhdhr = cdll.LoadLibrary("/Applications/hdhomerun_config_gui.app/Contents/Frameworks/libhdhomerun.dylib")
        else:
